...
<body>
    ...
    <!-- Hero Banner  -->
    <div class="banner-area auto-height banner-style-nine text-center text-light shadow theme-hard background-move bg-cover" style="background-image: url(assets/img/banner/asrama.png);">
        <div class="item-box">
            <div class="item">
                <div class="container">
                    <div class="row align-center">
                        ...
                        <div class="col-lg-8 offset-lg-2">
                            <div class="content">
                                ...
                                <h2 class="wow fadeInLeft text-hero" data-wow-delay="500ms">Sistem Informasi Manajemen<strong>Asrama Mahasiswa Balikpapan</strong></h2>
                                <h3 class="wow fadeInLeft text-hero" data-wow-delay="500ms">Keluarga Pelajar Mahasiswa Balipapan (KPMB) Makassar</h3>
                                <div class="button wow fadeInUp" data-wow-delay="700ms">
                                    <a class="btn btn-theme effect btn-md" href="#">Registrasi Warga Baru</a> 
                                </div>
                            </div>
                        </div>
    ...
    <div class="services-style-nine text-center default-padding-bottom bottom-less">
        <div class="container">
            <div class="services-style-nine-items">
                <div class="row">
                    <!-- Single Item -->
                    <div class="services-style-nine col-lg-3 col-md-6">
                        <div class="item">
                    ...
                    <div class="services-style-nine col-lg-3 col-md-6">
                        <div class="item">
                            ...
                            <h5><a href="#">Cloud Integration</a></h5>
                            <p>
                                Easy mind life fact with see Chatty can elinor direct for former. Up as meant.   
                            </p>
                        </div>
                    ...
                    <div class="services-style-nine col-lg-3 col-md-6">
                        <div class="item">
                            ...
                            <h5><a href="#">Analytic Solutions</a></h5>
                            <p>
                                Easy mind life fact with see Chatty can elinor direct for former. Up as meant.    
                            </p>
                        </div>
    ...
    <div class="about-style-nine-area default-padding-bottom">
        <div class="container">
            <div class="row align-center">
                ...
                <div class="about-style-nine col-lg-6">
                    <div class="info">
                        <h2 class="area-title">Companies Scale Engineer Capacity</h2>
                        <p>
                            We're committed to your complete satisfaction with our service. If you're not 100% happy, we'll do whatever it takes to make it right. new SimpliSafe home security package
                        </p>
                        <ul>
                        ...
                        <a class="btn btn-theme effect btn-md" href="#">Get started Now</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                    <div class="site-heading text-center">
                        <h5>Work Process</h5>
                        <h2 class="area-title">How we help your business grow</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="faq-content">
                            <h5>faq</h5>
                            <h2 class="area-title">Most common question & answer</h2>
                    ...
                    <div class="single-item col-lg-4">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <a class="btn-more" href="blog-single-with-sidebar.html">Read More <i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- End Single Item -->
                    ...
                    <div class="single-item col-lg-4">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <h4>
                                    <a href="blog-single-with-sidebar.html">My little garret repair to desire he esteem. </a>
                                </h4>
                                <p>
                                    Easy mind life fact with see has bore ten. Parish any chatty can elinor direct for former. Up as meant widow. 
                                </p>
